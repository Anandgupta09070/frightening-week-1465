            ...
            <div id="container">
                <div id="uppercontainer">
                    <div>
                        ...
                        <p className="message">Press Coverage</p>
                        <p className="message">Careers</p>
                        <p className="message">Business Partnership</p>
                        <p className="message">Become a Health Partner</p>
                    </div>

                    <div>
                        <h3>Our Policies</h3>
                        <p className="message">Privacy Policy</p>
                        <p className="message">Terms and Conditions</p>
                        <p className="message">Editorial Policy</p>
                        <p className="message">Return Policy</p>
                        <p className="message">IP Policy</p>
                        <p className="message">Grievance Redressal Policy</p>
                    </div>
                    <div>
                        <h3>Know Us</h3>
                        <p className="message">About Us</p>
                    ...
                    <div id="connect" >
                        <h3>Connect</h3>
                        <div><p className="message">social link</p></div>
                        <div id="logo1">
                        ...
                        <div><p className="message">Want daily dose of health?</p></div>
                ...
                <div id="secondbox">
                    <div class="box1">
                        ...
                        <div class="bigbox"><h2> Reliable</h2>
                            <p class="message" > All products displayed on Tata 1mg are procured from verified and licensed pharmacies. All labs listed on the platform are accredited </p>
                        </div>
                    </div>
                    <div class="box1">
